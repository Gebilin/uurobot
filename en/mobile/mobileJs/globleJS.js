...
$(function () {
    ...
    $('.list_search').click(function () {
        ...
        $('.hotSearch').click(function () {
            ...
            }else if($(this).html() == 'Customer service'){
                window.location.href="./service.html";
            }else if($(this).html() == 'Customization'){
    ...
    $('.searchBtn').click(function () {
        ...
        if($('.list_search input').val().toLowerCase() == 'Customer service'){
            window.location.href="./service.html";
        }else
        if($('.list_search input').val().toLowerCase() == 'Customization'){
            window.location.href="./customization.html";
        }else
