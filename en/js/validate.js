$(function () {
    ...
    function initia(n) {
        ...
        if (n == 0) {
            $('.cont-three textarea').attr('placeholder', 'Please give brief introduction of your city,company and requests for agency/customization/leasing of robots；')
        } else if (n == 1) {
            $('.cont-three textarea').attr('placeholder', 'Please give brief introduction of your city,company and requests for agency/customization/leasing of robots；')
        } else {
            $('.cont-three textarea').attr('placeholder', 'Please give brief introduction of your city,company and requests for agency/customization/leasing of robots；')
    ...
    function nameBlur() {
        ...
        if (name == '' || name == ' ') {
            ...
            $('.name-vali').html('*&nbsp;&nbsp;Your name');
            return false;
        }
        else if (!reg.test(name)) {
            $('#name').css({'border': '1px solid red'})
            $('.name-vali').html('*&nbsp;&nbsp;Incorrect input');
            return false;
        } else {
    ...
    function telBlur() {
        ...
        if (tel == '') {
            ...
            $('.tel-vali').html('*&nbsp;&nbsp;Your mobile ');
            return false;
        }
        else if (!reg.test(tel)) {
            $('#tel').css({'border': '1px solid red'})
            $('.tel-vali').html('*&nbsp;&nbsp;Incorrect input');
            return false;
        } else {
    ...
    function companyBlur() {
        ...
        if (company == '' || company == ' ') {
            ...
            $('.company-vali').html('*&nbsp;&nbsp;Your company name');
            return false;
        }
        else if (!reg.test(company)) {
            $('#company').css({'border': '1px solid red'})
            $('.company-vali').html('*&nbsp;&nbsp;Incorrect input');
            return false;
        } else {
    ...
    function detBlur() {
        ...
        if (det == '' || det == ' ') {
            ...
            $('.det-vali').html('*&nbsp;&nbsp;Your brief description');
            return false;
        }
        else if (!reg.test(det)) {
            $('#det').css({'border': '1px solid red'})
            $('.det-vali').html('*&nbsp;&nbsp;Incorrect input)');
            return false;
        } else {
